...
public class ProjectileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        parentView= inflater.inflate(R.layout.fragment_projectile,container,false);
...
//        Button unit6 = (Button) parentView.findViewById(R.id.UNIT_6);
        ...
        xplore3d.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                changeFragment(new ProjMotion3DFragment());
            }
        });
       ...
       lab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                changeFragment(new LabProjMotionFragment());
            }
        });
