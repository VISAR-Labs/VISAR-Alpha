...
import com.kumar.dipanshu.visar.Fragments.Physics.SWL.Waves.Waves3DFragment;
...
public class LightFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        parentView= inflater.inflate(R.layout.fragment_light, container,false);
...
//        Button unit6 = (Button) parentView.findViewById(R.id.UNIT_6);
        ...
        ar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                changeFragment(new ARLightFragment());
        ...
        xplore3d.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                changeFragment(new Light3DFragment());
            }
        });
        ...
        lab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                changeFragment(new LabLightFragment());
            }
        });
