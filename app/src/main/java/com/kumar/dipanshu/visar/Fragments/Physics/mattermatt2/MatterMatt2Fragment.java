...
public class MatterMatt2Fragment extends Fragment {
    private View parentView;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        parentView= inflater.inflate(R.layout.fragment_matter_matt2,container,false);
...
//        Button unit6 = (Button) parentView.findViewById(R.id.UNIT_6);
        ...
        lab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                changeFragment(new LabMatter2Fragment());
